...
const agentOverrides: Record<string, Partial<JarvisAgent>> = {
  ...
  reviewer: {
    ...
    history: [
      ...
      "#66 610b0005 is the current repaired head after two deeper P1 session-recovery findings on 1c7d3227; durable launch-session identity and PGID-independent full-session recovery are implemented, with fresh exact-head certification running. #46 0ddb5e8e remains exact-head CI green with clean fresh Codex review 5768921053.",
...
const operatorTasks: JarvisTask[] = [
  { id:"t1", title:"Trusted Bridge durable-session repair", projectId:"jarvis", project:"JARVIS", agent:"AI Reviewer", state:"review", detail:"Fresh review of #66 predecessor 1c7d3227 found two P1s: descendants changing PGID could escape cleanup, and Reviewer session identity was not durable across a crash. Current exact 610b0005 repairs both with durable launch-session evidence and PGID-independent session recovery. Fresh exact-head certification is running. Bridge remains NOT installed." },
  ...
  { id:"t16", title:"Independent review queue", projectId:"jarvis", project:"JARVIS", agent:"AI Reviewer", state:"review", detail:"Issue #109 is canonical. #66 current exact 610b0005 carries the newest P1 durable-session repairs and is in fresh exact-head certification; stale-SHA review is never approval, and all 1c7d3227 and earlier review evidence is stale. #46 0ddb5e8e is exact-head CI green and independently clean. Neither component is installed." },
