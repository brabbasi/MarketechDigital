...
const operatorTasks: JarvisTask[] = [
  ...
  { id:"t16", title:"Independent review queue", projectId:"jarvis", project:"JARVIS", agent:"AI Reviewer", state:"review", detail:"Issue #109 is canonical. #66 exact ec430d53 is fully engineering-green with all known review threads resolved and fresh exact-head Codex re-review 5784130246 requested; stale-SHA review is never approval, including predecessor 289d22a4 evidence. #46 0ddb5e8e is exact-head CI green and independently clean. Neither component is installed." },
