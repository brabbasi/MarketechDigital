...
const operatorTasks: JarvisTask[] = [
  ...
  { id:"t16", title:"Independent review queue", projectId:"jarvis", project:"JARVIS", agent:"AI Reviewer", state:"review", detail:"Issue #109 is canonical. #66 exact 4e030d19 has all five required gates green and Codex review 5823835009 clean; governed bootstrap artifact 10838162352 is frozen for Founder-local install. MemPalace #36 exact 79df2683 remains independently clean on the sealed-memory lane. #46 0ddb5e8e remains exact-head CI green and independently clean. Nothing is considered installed until live proof exists." },
