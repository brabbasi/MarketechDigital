...
const operatorTasks: JarvisTask[] = [
  { id:"t1", title:"Trusted Bridge final install-blocker repair", projectId:"jarvis", project:"JARVIS", agent:"AI Reviewer", state:"review", detail:"#66 exact 4e030d19 repairs the latest Codex P1 by fsyncing the full staged release tree before atomic final-directory publish, preventing power-loss persistence of a partial exact release. Fresh five-gate certification is queued. No older bootstrap package may be rerun. Bridge remains NOT installed." },
...
export const operatorJarvisState: JarvisState = {
  ...
  tasks: operatorTasks,
  finishChain: {
    bridge: "staged_release_durability_p1_repaired_exact_head_ci_queued",
