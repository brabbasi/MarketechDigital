...
const operatorTasks: JarvisTask[] = [
  { id:"t1", title:"Trusted Bridge durable-session repair", projectId:"jarvis", project:"JARVIS", agent:"AI Reviewer", state:"review", detail:"Fresh review of #66 exact 6bba545a found two P1s: unproven sessions were not durably fenced across retries, and a persisted session leader PID could be reused before signaling. Current exact c1382eb7 repairs both with a durable recovery fence and strict leader start-time/session reuse checks. Exact-head certification is queued/running. Bridge remains NOT installed." },
  ...
  { id:"t16", title:"Independent review queue", projectId:"jarvis", project:"JARVIS", agent:"AI Reviewer", state:"review", detail:"Issue #109 is canonical. #66 current exact c1382eb7 carries the newest recovery-fence/PID-reuse repairs and is in exact-head certification; all earlier #66 review evidence is stale. MemPalace #36 exact 767e0f73 is separately in fresh Codex review 5803557274. #46 0ddb5e8e remains exact-head CI green and independently clean. Nothing is installed." },
