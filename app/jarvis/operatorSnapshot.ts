...
const SNAPSHOT_AT = "2026-09-23T23:29:00Z";

const projectOverrides: Record<string, Partial<JarvisProject>> = {
  jarvis: {
    state: "review",
    progress: 82,
    now: "P0 finish chain remains #66 -> #46 -> #40 -> #80. Exact #66 head 949296f5 is fully engineering-green: Bridge 35932910487, Action Guard 35932910475, Phase-0 35932910455, AI Reviewer CI 35932910456 and Observability 35932910452 are all SUCCESS. Both remaining P1 threads are resolved with exact-head evidence and fresh Codex review 5804649774 is requested; Bridge is still not installed. In parallel, MemPalace #36 exact fdff6319 carries portable private-tmpfs runner-root masking plus exact-head audit checkout fixes; Install Wave 1 and Portfolio Audit are green and the decisive sealed no-network sandbox run is active. Issue #123 remains the durable capability ledger. Hermes #121 is pinned to v2026.9.21 / d337b736 and AwesomeLLMApps #122 to c6228784. #46 remains clean/not installed and #40 remains Runtime OFF.",
    next: "Consume fresh Codex review 5804649774 on unchanged #66 949296f5; only a clean exact-head verdict may advance to the separate Founder Bridge-install decision. In parallel, finish MemPalace #36 certification on fdff6319; if its sealed sandbox + web audit are green, resolve the current filesystem-isolation/audit P1/P2 threads with exact-run evidence and request fresh independent review. Continue Hermes/AwesomeLLMApps read-only audit/extraction through #121/#122/#123. Runtime/autonomy/outbound/spend remain OFF.",
    blocked: 2,
    lastUpdate: "#66 exact 949296f5 now has all five required engineering gates green, both final P1 threads resolved, and fresh Codex review 5804649774 requested. MemPalace #36 exact fdff6319 has its portable runner-root masking repair under active sealed certification, with Install Wave 1 + Portfolio Audit already green. Hermes/AwesomeLLMApps remain durably pinned under #121/#122/#123. No Bridge, Reviewer, Runtime, real memory corpus or external authority has been activated.",
    history: [
...
const operatorTasks: JarvisTask[] = [
  ...
  { id:"t16", title:"Independent review queue", projectId:"jarvis", project:"JARVIS", agent:"AI Reviewer", state:"review", detail:"Issue #109 is canonical. #66 exact 949296f5 has all five required gates green, both final P1 threads resolved and fresh review 5804649774 requested. MemPalace #36 exact fdff6319 is under fresh sealed certification with Install Wave 1 + Portfolio Audit green. #46 0ddb5e8e remains exact-head CI green and independently clean. Nothing is installed; stale-SHA review is never approval." },
