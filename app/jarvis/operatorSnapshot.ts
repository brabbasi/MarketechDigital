...
const SNAPSHOT_AT = "2026-09-23T22:07:00Z";

const projectOverrides: Record<string, Partial<JarvisProject>> = {
  jarvis: {
    state: "review",
    progress: 82,
    now: "P0 finish chain remains #66 -> #46 -> #40 -> #80. Current exact #66 head 88db56ea has all five required gates SUCCESS; the two latest recovery P1s are resolved with exact-head evidence and fresh Codex review 5803724655 is active. Bridge is not installed. In parallel, MemPalace PR #36 fresh review found two real isolation gaps: candidate visibility of runner mounts and missing external anchoring of the sealed manifest digest. Both are repaired on current exact #36 head 61ee6d17 with a chrooted mount/PID/network sandbox, capability drop, read-only sealed inputs, one bounded writable scratch tree, and an externally retained manifest digest; fresh exact-head CI is running. The canonical Memory Router and disabled-by-default MemPalaceReadOnlyAdapter already exist. #46 exact 0ddb5e8e remains clean/not installed and #40 remains Runtime OFF.",
    next: "Consume fresh Codex review 5803724655 on unchanged #66 88db56ea; only a clean exact-head verdict may advance to the separate Founder Bridge-install decision. In parallel, finish #36 exact 61ee6d17 sealed CI, resolve its two isolation findings with exact evidence, request fresh review, then advance the existing read-only MemPalace adapter through synthetic project-scope/provenance/retention/failure evaluation before any real corpus ingestion. Hermes first bounded extraction remains read-only session search behind the Memory Router after the MemPalace contract is cleared. Keep #46 exact 0ddb5e8e frozen clean behind #66; Runtime/autonomy/outbound/spend remain OFF.",
    blocked: 2,
    lastUpdate: "#66 exact 88db56ea is fully engineering-green and in fresh exact-head review. MemPalace #36 advanced to exact 61ee6d17 after fresh review exposed two isolation gaps; both are repaired and real self-hosted sealed validation is running. Hermes/AwesomeLLMApps remain durably tracked in Issue #123 with selective-integration rules. No Bridge, Reviewer, Runtime, real memory corpus or external authority has been activated.",
    history: [
...
const operatorTasks: JarvisTask[] = [
  { id:"t1", title:"Trusted Bridge durable-session repair", projectId:"jarvis", project:"JARVIS", agent:"AI Reviewer", state:"review", detail:"#66 exact 88db56ea has Bridge 35925481145, Action Guard 35925480990, Phase-0 35925480994, AI Reviewer CI 35925481161 and Observability 35925480981 all SUCCESS. Both latest recovery P1s are resolved; fresh exact-head Codex review 5803724655 is active. Bridge remains NOT installed." },
  ...
  { id:"t16", title:"Independent review queue", projectId:"jarvis", project:"JARVIS", agent:"AI Reviewer", state:"review", detail:"Issue #109 is canonical. #66 exact 88db56ea is fully green and fresh review 5803724655 is active; stale-SHA review is never approval. MemPalace #36 review on 767e0f73 found two isolation blockers now repaired on 61ee6d17, whose fresh CI/review must bind that new SHA. #46 0ddb5e8e remains exact-head CI green and independently clean. Nothing is installed." },
  ...
  { id:"t42", title:"MemPalace persistent memory lane", projectId:"jarvis", project:"JARVIS", agent:"Memory Router Specialist", state:"review", detail:"Fresh review of PR #36 exact 767e0f73 found a P1 runner-mount exposure and P2 mutable-manifest trust gap. Current exact 61ee6d17 repairs both with a chrooted read-only mount/PID/network sandbox, namespace capability drop, bounded writable /work only, and external acquisition-manifest digest anchoring. Fresh sealed self-hosted CI is running. Canonical Memory Router plus disabled-by-default MemPalaceReadOnlyAdapter already exist; real company/client corpus ingestion and MCP/model/provider/write authority remain OFF." },
