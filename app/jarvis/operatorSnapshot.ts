...
const operatorTasks: JarvisTask[] = [
  ...
  { id:"t16", title:"Independent review queue", projectId:"jarvis", project:"JARVIS", agent:"AI Reviewer", state:"review", detail:"Issue #109 is canonical. #66 exact 1c7d3227 is 5/5 engineering-green with fresh Codex review 5784694177 requested; all predecessor review evidence is stale. #46 0ddb5e8e is exact-head CI green and independently clean. Neither component is installed." },
