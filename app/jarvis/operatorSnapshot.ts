...
const operatorTasks: JarvisTask[] = [
  { id:"t1", title:"Trusted Bridge exact-head re-review", projectId:"jarvis", project:"JARVIS", agent:"AI Reviewer", state:"review", detail:"#66 exact 4e030d19 repairs the latest Codex P1 by fsyncing the full staged release tree before atomic final-directory publish. Trusted Machine Bridge CI 36071283885, Action Guard 36071283881, Phase-0 36071283990, AI Reviewer CI 36071283979 and Observability 36071283912 are all SUCCESS. P1 is resolved; fresh Codex review 5823804142 is requested. No older bootstrap package may be rerun. Bridge remains NOT installed." },
  ...
  { id:"t16", title:"Independent review queue", projectId:"jarvis", project:"JARVIS", agent:"AI Reviewer", state:"review", detail:"Issue #109 is canonical. #66 current exact 4e030d19 has all five required gates green, latest P1 resolved, and fresh Codex review 5823804142 requested. MemPalace #36 exact 79df2683 is independently clean with sealed/install/portfolio/web gates green. #46 0ddb5e8e remains exact-head CI green and independently clean. Nothing is installed; stale-SHA review is never approval." },
