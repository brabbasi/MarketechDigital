...
const operatorTasks: JarvisTask[] = [
  ...
  { id:"t16", title:"Independent review queue", projectId:"jarvis", project:"JARVIS", agent:"AI Reviewer", state:"review", detail:"Issue #109 is canonical. #66 exact 949296f5 carries the current request-context recovery fix and aligned regressions; Observability is green and remaining certification gates are queued. MemPalace #36 exact 2503369b carries the latest sandbox/audit repairs and is queued for certification. #46 0ddb5e8e remains exact-head CI green and independently clean. Nothing is installed." },
