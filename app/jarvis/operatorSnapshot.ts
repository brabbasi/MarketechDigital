...
const SNAPSHOT_AT = "2026-09-24T23:19:00Z";

const projectOverrides: Record<string, Partial<JarvisProject>> = {
  jarvis: {
    state: "review",
    progress: 82,
    now: "P0 finish chain remains #66 -> #46 -> #40 -> #80. The real governed Founder-local bootstrap has already exposed and driven fixes for the Windows-to-WSL numeric/CR framing failure, retained diagnostic durability, same-ref launcher serialization, local GitHub CLI pagination compatibility, retry gate uniqueness, exact-release crash recovery and direct LF byte streaming. Fresh Codex review of predecessor #66 head 14bcea09 found one remaining install-blocking durability gap: staged release contents were not fsynced before the atomic final-directory publish, so a power loss could leave a durable-but-corrupt exact release. Current exact #66 head 4e030d19 fsyncs every staged regular file and directory bottom-up before rename and adds a regression enforcing durability-before-publish. All five required exact-head gates are SUCCESS on 4e030d19 and fresh Codex review 5823835009 is CLEAN ("Didn't find any major issues"). The exact governed bootstrap artifact trusted-machine-bridge-bootstrap from Bridge CI 36071283885 is frozen to 4e030d19 and is now the only allowed package for Founder-local installation. Bridge remains NOT installed until that exact launcher succeeds and publishes durable proof. In parallel, MemPalace #36 exact 79df2683 remains OPEN on the sealed-memory lane; Issue #123 is the canonical external capability registry; Hermes #121 and AwesomeLLMApps #122 remain bounded audit/extraction lanes. #46 remains clean/not installed and #40 remains Runtime OFF.",
    next: "Run only the frozen governed bootstrap artifact from Bridge CI 36071283885, exact #66 head 4e030d19. The launcher itself materializes a fresh <=900s Founder exact-ref approval from the explicit launch decision, verifies exact installer blob/ref and Trusted identity, and durably publishes the result. No older bootstrap package may be rerun. A successful local launch must prove the live Bridge healthy before clean #46 is installed through it; then the live Reviewer reviews #40 before any Runtime/Autonomy Phase A decision. In parallel, continue MemPalace #36 and Hermes/AwesomeLLMApps bounded work through #121/#122/#123. Runtime/autonomy/outbound/spend remain OFF.",
    blocked: 2,
    lastUpdate: "#66 exact 4e030d19 is now install-ready: all five required gates are SUCCESS and Codex review 5823835009 is clean. The only valid bootstrap is artifact 10838162352 from Bridge CI 36071283885, bound to exact 4e030d19; no older package may be used. The external capability backlog is durably canonical in Issue #123; a duplicate reconciliation issue was closed rather than creating a second registry. MemPalace #36 remains OPEN; Hermes #121 and AwesomeLLMApps #122 continue in bounded parallel lanes. No Bridge, Reviewer, Runtime, real memory corpus or external authority has been activated yet.",
    history: [
