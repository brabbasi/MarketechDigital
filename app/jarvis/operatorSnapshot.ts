...
export const operatorJarvisState: JarvisState = {
  ...
  tasks: operatorTasks,
  finishChain: {
    bridge: "bootstrap_p2_repaired_ci_assertion_fixed_exact_head_running",
