...
export const operatorJarvisState: JarvisState = {
  ...
  tasks: operatorTasks,
  finishChain: {
    bridge: "bootstrap_p2_repaired_exact_head_ci_running",
