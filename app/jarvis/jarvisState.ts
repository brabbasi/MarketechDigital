...
export const demoJarvisState: JarvisState = {
  ...
  tasks: [
    ...
    { id:"t5", title:"Revenue research review batch", projectId:"jarvis", project:"Revenue", agent:"Revenue Agent", state:"queued", detail:"33 newest packets await independent review; 69 qualified total; five direct outreach threads rechecked with zero replies; no outbound." },
    ...
    { id:"t16", title:"Independent review capacity", projectId:"jarvis", project:"JARVIS", agent:"AI Reviewer", state:"blocked", detail:"Issue #109 is the canonical blocker for #66/#46/#47/#93/#98/#101/#104/#15/#16/#17. No passing CI is treated as independent approval." }
  ],
  revenue: {
