...
export const demoJarvisState: JarvisState = {
  ...
  agents: [
    ...
    { id:"revenue", name:"Revenue Agent", short:"RV", department:"Revenue", state:"running", x:16, y:63, load:49, task:"Research + pipeline movement", skills:["qualification","research","pipeline"], workers:[{name:"Revenue Assessment Trainee",state:"evaluation",last:"current"}], history:["66 qualified prospects in canonical queue","30 newest packets await independent review","Five directly traceable outreach threads rechecked with zero replies","Outbound remains governed and held"] },
  ...
  projects: [
    {
      ...
      now:"Cockpit v9 live; remote Founder portal bdb4c226 is deployed with the private Blob mirror driver fail-closed; #93/#98/#101/#104 remain engineering-green", next:"Independent reviews remain the gate; connect one private Marketech Blob store only after governed approval, then bind #104 publisher to the reviewed ingestion path while preserving #66 -> #46 -> #40 -> #80.",
      blocked:1, repo:"brabbasi/Marketech_Digital_OS", lastUpdate:"Remote Founder portal bdb4c226 is deployed and QA-green; #104 publisher is hardened/green, Blob driver is code-ready but no store/write secret/ingest activation exists; review capacity remains the shared gate",
    ...
    },
    {
      ...
      now:"Founder Portal bdb4c226 is deployed on the rolling Vercel alias with Next 15.5.24, browser QA, Founder Truth strip and private Blob driver green", next:"Keep auth/consequence controls gated; clear #16/#17 reviews and connect one private Marketech Blob store before any signed snapshot publication.",
      blocked:1, repo:"brabbasi/MarketechDigital", lastUpdate:"PR #13 exact bdb4c226 is deployed and QA-green; #16 preview-budget and #17 favicon runtime fix are engineering-green/review-gated; private Blob store is not connected yet",
  ...
  revenue: {
    qualifiedProspects: 66,
    pendingIndependentReview: 30,
